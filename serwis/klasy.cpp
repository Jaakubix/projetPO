...
void sprawdzStatusSerwisu(const SerwisKomputerowy& serwis) {
    cout << "Serwis komputerowy: " << serwis.nazwa << " znajduje siê pod adresem: " << serwis.adres << endl;
}

void zamowCzesc(const CzescZamienna& czesc) {
    cout << "Zamówienie czêœci: " << czesc.nazwa << ", model: " << czesc.model << ", cena: " << czesc.cena << " PLN" << endl;
}